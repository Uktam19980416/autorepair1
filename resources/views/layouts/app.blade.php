        ...
        <div>
            ...
            <div class="  text-white cursor-pointer">
                <ul class="flex p-4 items-center justify-evenly">
                    ...
                    <li class="hidden lg:flex hover:text-orange-600 w-1/6 ml-10"><a href="./price.html"> ЦЕНЫ </a></li>
                    <li class="hidden lg:flex hover:text-orange-600 w-1/6"><a href="./review.html"> ОТЗЫВЫ </a></li>
                    <li class="hidden lg:flex hover:text-orange-600 w-1/6"><a href="./contact.html"> КОНТАКТЫ </a></li>
...
<div class="bg-blue-600 text-center py-16">
    <div class=" mx-8">
        ...
        <div class="flex items-center justify-between ml-10 flex-wrap lg:w-1/5 w-full  bg-white flex-col mx-4 mt-8 py-8 px-14 relative hover:shadow-2xl">
            ...
            <p>Звоните нам по телефону <br><a class="text-blue-500 font-extrabold cursor-pointer" href="tel:+79067031111">+7 (906)703-11-11</a></p>
        </div>
        <div class="flex items-center justify-between ml-10 flex-wrap lg:w-1/5 w-full bg-white flex-col mx-4 mt-8 py-8 px-14 relative hover:shadow-2xl">
    ...
    <div class="flex-col">
        ...
        <div class="flex text-center justify-center items-center flex-wrap">
            <div class="owl-carousel owl-theme">
                <div class="item shadow-2xl  lg:ml-10 border-2 border-white px-24 md:px-12 my-10 lg:px-8 sm:py-8 hover:border-orange-500"> <img class='rounded-full' src="https://auto-help-spb.ru/assets/cache_image/images/top/buksirovka-avtomobilya_90x90_be4.jpg" alt="">
                    <p class="py-4">Буксировка автомобиля</p>
                    <p  class=" py-4 font-extrabold text-lg">от 1000 руб.</p>
                    <button onclick="orderFormBtn()" class="font-extrabold text-blue-500 border-2 border-blue-500 py-2 px-10 hover:bg-blue-500 hover:text-white transition duration-300">Заказать</button></div>
                <div class="item shadow-2xl  lg:ml-10 border-2 border-white px-24 md:px-12 my-10 lg:px-8 sm:py-8 hover:border-orange-500"> <img class='rounded-full' src="https://auto-help-spb.ru/assets/cache_image/images/top/buksirovka-avtomobilya_90x90_be4.jpg" alt="">
            <p class="py-4">Буксировка автомобиля</p>
            <p  class=" py-4 font-extrabold text-lg">от 1000 руб.</p>
            <button onclick="orderFormBtn()" class="font-extrabold text-blue-500 border-2 border-blue-500 py-2 px-10 hover:bg-blue-500 hover:text-white transition duration-300">Заказать</button></div>
